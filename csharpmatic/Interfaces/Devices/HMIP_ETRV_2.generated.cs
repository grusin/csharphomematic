...
{
    public partial class HMIP_ETRV_2 : Device, ILowBatteryInfo, IOperatingVoltageInfo, ITempControlDevice, IHmIPDevice, IValveControlDevice
    {
        ...
        public HMIP_ETRV_2(XMLAPI.DeviceList.Device d, XMLAPI.Client CGIClient, DeviceManager dm) : base(d, CGIClient, dm)
        {
